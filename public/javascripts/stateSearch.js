    ...
    if (suggestionSelected && query.trim() !== "") {
      ...
      if (selectedState !== "") {
        ...
        totalPages = Math.ceil(
          totalAvailableSearchResults / requestedNumResults
        );
...
function updatePaginationButtons() {
  ...
  if (
    ...
    totalAvailableSearchResults - beginningParksArray <= requestedNumResults
  ) {
...
function startParkInfoReq(parkID) {
  ...
  window.location.href = "/parkRoute";
}
